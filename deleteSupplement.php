<?php
    ...
    if (!empty($_POST)) {
       ...
       $db = Database::connect();
       $statement = $db->prepare("DELETE FROM supplements WHERE sid = ?");
        ...
        <h1 class="text-logo"><span class="glyphicon glyphicon-cutlery"></span> Pizza en ligne <span class="glyphicon glyphicon-cutlery"></span></h1>
         <div class="container admin">
            <div class="row">
                ...
                <br>
                <form class="form" action="<?php echo'deleteSupplement.php?id='.$id; ?> " role="form" method="post" enctype="multipart/form-data">
